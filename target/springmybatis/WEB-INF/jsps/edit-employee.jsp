...
<body>
	...
	<s:form class="form ml-5 mr-5 d-flex flex-column" action="updateEmployee" modelAttribute="employee">
		...
		<div class="form-group row">
			<input class="form-control btn btn-warning" type="submit" value="Update Employee" />
		</div>
	</s:form>
